...
public static void main(String[] args) {
 ...
 int[] board = new int[15]; 					//Declare a new board
 ArrayList<Integer> fillP = new ArrayList<Integer>();		//An arraylist for the filled pegs
 ArrayList<Integer> freeP = new ArrayList<Integer>();		//An arraylist for the free spaces
 ArrayList<int[]> moves = new ArrayList<int[]>();		//An arraylist for the possible moves
 int numPegs = 0;
	...
	for(int i=0;i<5;i++)
	{
		...
		move(board,moves,fillP,freeP,numPegs);
				...
				for(int j=0;j<14;j++)
				{
					//go through the moves and show the steps
